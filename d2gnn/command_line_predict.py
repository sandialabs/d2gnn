...
def main():
    ...
    structures, _, _, _, _ = dataset[0] #<- Fxyz mod
    ...
    if args.debug:
        with open(os.path.join(args.resultdir,'debug_model_CLpredict.txt'),'w') as f:
            ...
            if args.cuda:
                ...
                if model_args.model_type == 'cgcnn':
                    ...
                    if args.debug:
                        print(batch_cif_ids)
                        print('atom_fea:')
                        print(Variable(input[0]).shape)
                        print(Variable(input[0]))
                        print('nbr_fea:')
                        print(Variable(input[1]).shape)
                        print(Variable(input[1]))
                        print('nbr_fea_idx:')
                        print(Variable(input[2]).shape)
                        print(Variable(input[2]))
